                ...
                <div className="space-y-1.5 animate-slide-up delay-600">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="block w-full rounded-xl border border-gray-200 bg-white px-4 py-3 pr-11 text-gray-900 shadow-sm transition-all duration-200 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 hover:border-gray-300"
